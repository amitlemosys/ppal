...
$url=route('checkout.payment.paypal', [1,'transaction_id' =>$transaction_id]);
...
//print_r($url); die();
    ...
    { //echo "<pre>"; print_r(decrypt($transaction_id)); print_r($request->all()); die;
            $order = Order::find(1);

            $paypal = new PayPal;

            $response = $paypal->purchase([
                'amount' => $paypal->formatAmount(100),
